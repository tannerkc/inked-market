      ...
      <div className="flex items-center gap-3">
        <div
          className={cn(
            ...
            isDark ? "bg-ink-cream/[0.04]" : "bg-ink-black/[0.04]"
          )}
        >
          {icon}
        </div>
    ...
    >
      <div className={cardClass}>
        <ProviderCard
          name="Instagram"
          icon={
            <svg className={cn("w-4 h-4", isDark ? "text-ink-cream/40" : "text-ink-black/40")} fill="currentColor" viewBox="0 0 24 24">
      ...
      <p className={cn("text-[10px] mt-3 px-1", isDark ? "text-ink-cream/20" : "text-ink-black/20")}>
