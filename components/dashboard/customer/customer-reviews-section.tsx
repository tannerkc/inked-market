                    ...
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <StarRating
                          ...
                          className={cn(
                            isDark ? "text-ink-rust/70" : "text-ink-rust"
                          )}
                        />
                        <span
                          className={cn(
                            "font-mono text-[9px] tracking-[0.1em] uppercase rounded-full px-1.5 py-0.5",
                            isDark
                              ? "bg-ink-cream/[0.06] text-ink-cream/35"
                              : "bg-ink-black/[0.06] text-ink-black/35"
                          )}
                        >
                          {review.targetType}
                        </span>
