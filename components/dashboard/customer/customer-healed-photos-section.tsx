        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          {photos.map((photo) => (
            <div key={photo.id} className="group">
              <div className="aspect-square rounded-lg overflow-hidden flex items-center justify-center transition-colors bg-ink-black/[0.04] group-hover:bg-ink-black/[0.06] dark:bg-ink-cream/[0.04] dark:group-hover:bg-ink-cream/[0.06]">
                {photo.url ? (
                  <img
                    src={photo.url}
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    className="text-ink-black/15 dark:text-ink-cream/15"
                  >
                    <path
              ...
              <div className="mt-1.5 flex items-start justify-between gap-1">
                ...
                {photo.approvedForPortfolio && (
                  <span className="font-mono text-[9px] tracking-[0.1em] uppercase rounded-full px-1.5 py-0.5 flex-shrink-0 whitespace-nowrap bg-ink-sage/10 text-ink-sage dark:text-ink-sage/70">
                    In Portfolio
                  </span>
                )}
              </div>
