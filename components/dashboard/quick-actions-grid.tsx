      ...
      <div className="grid grid-cols-3 gap-2.5">
        {actions.map((action) => (
          <div
            ...
            className={`rounded-2xl p-4 border cursor-pointer transition-all hover:-translate-y-px ${isDark ? "bg-ink-cream/[0.03] border-ink-cream/[0.06] hover:border-ink-cream/[0.12]" : "bg-ink-black/[0.02] border-ink-black/[0.06] hover:border-ink-black/[0.12]"}`}
          >
