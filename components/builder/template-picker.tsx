...
export function TemplatePicker({ onSelectTemplate }: TemplatePickerProps) {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--chrome-bg)" }}>
      {/* Fixed top bar */}
      <div
        ...
        style={{
          ...
          borderBottom: "1px solid var(--chrome-raised)",
        }}
      >
        <Link
          href="/dashboard"
      ...
      <div className="pt-28 pb-10 text-center px-4">
        <h1
          ...
          style={{ fontFamily: "'Bebas Neue', sans-serif", color: "var(--chrome-text-primary)" }}
        >
          Choose Your Template
        </h1>
        <p
          className="text-[14px] sm:text-[16px] leading-relaxed mx-auto"
          style={{ color: "var(--chrome-text-tertiary)", maxWidth: 480 }}
        >
