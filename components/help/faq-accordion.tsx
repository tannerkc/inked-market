        ...
        return (
          <div
            ...
            className={cn(
              ...
              isOpen
                ? "border-ink-black/[0.08] bg-ink-black/[0.03] dark:border-ink-cream/[0.08] dark:bg-ink-cream/[0.03]"
          ...
          >
            ...
            >
              <span
                className={cn(
                  ...
                  isOpen
                    ? "text-ink-black/80 dark:text-ink-cream/80"
                    : "text-ink-black/50 group-hover:text-ink-black/65 dark:text-ink-cream/50 dark:group-hover:text-ink-cream/65"
                )}
              >
                {item.question}
              </span>
            ...
            >
              <div className={cn(
                ...
                "dark:text-ink-cream/45 dark:[&_strong]:text-ink-cream/60"
              )}>
                {item.answer}
              </div>
            </div>
